...
<center>
    <div class='topnav'>
				...
				<a class='active' href='cadastro_e.php'>Novo</a>
													...
													<div class='center-wrap'>
														<form method='post' action='cadastrar_e.php'>
															...
															<div class='form-group'>
																	<input type='text' class='form-style' placeholder='Nome da Empresa' name='nome_e' id='nome_e' required>
																	<i class='input-icon uil uil-at'></i>
																</div>
																<br>
															<div class='form-group'>
																	<input type='number' class='form-style' placeholder='CNPJ' name='cnpj' id='cnpj' required>
																	<i class='input-icon uil uil-at'></i>
																</div>
																<br>
																<div class='form-group'>
